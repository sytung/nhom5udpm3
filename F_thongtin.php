...
<link rel="stylesheet" href="F_CSS_thongtin.css">
...
<body>
	<form method="post" enctype="multipart/form-data">
      ...
      <div class="text-dk">
        ...
        <a href="F_thongtin.php">Thông tin</a>
      </div>  
	

      <div class="title_box_center">
      	<h2 class="h_title">Thông tin</h2>        
      </div>  
      ...
      <div class="box-dk1">
			...
			?>
            <div class="othongtin">
            	<?php echo"Họ tên : ".$row['hoten']."" ?>
            </div>
            
            <div class="othongtin">
            	<?php echo"Tuỏi : ".$row['tuoi']."" ?>
            </div>
            
           <div class="othongtin">
           		<?php echo"Giới tính : ".$row['gioitinh']."" ?>
           </div>   
           
           <div class="othongtin">
           		<?php echo"Quê quán : ".$row['quequan']."" ?>
           </div>                 
           
           <div class="othongtin">
           		<?php echo"Số điện thoại : ".$row['sdt']."" ?>
           </div>    
           
           <div class="othongtin">
           		<?php echo"Số tài khoản : ".$row['stk']."" ?>
           </div>
           
           <div class="othongtin">
           		<?php echo"Số dư : ".$row['tien']."" ?>
           </div>                              
