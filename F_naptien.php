...
<link rel="stylesheet" href="F_CSS_naptien.css">
...
<body>
	<form method="post" enctype="multipart/form-data">
      ...
      <div class="text-dk">
        ...
        <a href="F_naptien.php">Nạp tiền</a>
      </div>  
	

      <div class="title_box_center">
      	<h2 class="h_title">Nạp tiền</h2>        
      </div>  
      
      <div class="box-dk1">
        <div class="text1">Số tiền cần nạp</div>
        ...
        <div class="submit"><input type="submit" name="naptien" value="Nạp tiền"></div>
      </div>  
		...
		$run=mysqli_query($conn,$sql);
				...
				if($run)
				{
					echo '<script type="text/javascript">
								alert("Nạp tiền thành công! Vui lòng ấn nút thông tin để kiểm tra số dư");
				 			</script>';	
				}
				else
					{	 echo'<script type="text/javascript">
								alert("Rất tiếc! Nạp tiền không thành công");
				 			</script>';
					}
