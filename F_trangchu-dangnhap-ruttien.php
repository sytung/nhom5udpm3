...
<link rel="stylesheet" href="F_CSS_ruttien.css">
...
<body>
	<form method="post" enctype="multipart/form-data">
      ...
      <div class="text-dk">
        ...
        <a href="F_trangchu-dangnhap-ruttien.php">Rút tiền</a>
      </div>  
	

      <div class="title_box_center">
      	<h2 class="h_title">Rút tiền</h2>        
      </div>  
      
      <div class="box-dk1">
        <div class="text1">Số tiền cần rút</div>
        ...
        <div class="submit"><input type="submit" name="ruttien" value="Rút tiền"></div>
      </div>  
                ...
                if($row['tien']<$tien)
                    {
                    	echo'<script type="text/javascript">
									alert("Rất tiếc! Bạn không đủ số dư");
							  </script>';
					}
                    ...
                    $run=mysqli_query($conn,$sql);
							...
							{
								echo'<script type="text/javascript">
											alert("Rút tiền thành công! Vui lòng ấn vào ô thông tin để kiểm tra số dư");
									  </script>';
               				}	
							else
